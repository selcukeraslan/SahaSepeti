...
export function Footer() {
  return (
    <footer className="mt-auto border-t border-slate-200 bg-white dark:border-ink-800 dark:bg-ink-900">
      <Container className="flex flex-col gap-6 py-10 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap gap-x-12 gap-y-6">
          <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-ink-50">Keşfet</p>
            <ul className="mt-3 space-y-2 text-sm text-slate-500 dark:text-ink-400">
              <li>
          ...
          <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-ink-50">Tesis Sahibi misiniz?</p>
            <ul className="mt-3 space-y-2 text-sm text-slate-500 dark:text-ink-400">
              <li>
          ...
          <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-ink-50">Kurumsal</p>
            <ul className="mt-3 space-y-2 text-sm text-slate-500 dark:text-ink-400">
              <li>
      ...
      <div className="border-t border-slate-100 py-4 dark:border-ink-800">
        <Container>
