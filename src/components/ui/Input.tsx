  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        className={cn(
          'h-11 rounded-xl border bg-white dark:bg-slate-900 px-3.5 text-sm text-slate-900 dark:text-slate-50 placeholder:text-slate-400 dark:placeholder:text-slate-500',
