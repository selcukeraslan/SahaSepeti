...
export function VenueForm({ defaultValues, isSaving, submitLabel, onSubmit }: VenueFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5" noValidate>
      ...
      {/* Spor türleri */}
      <fieldset>
        <legend className="text-sm font-medium text-slate-700 dark:text-ink-200">Spor Türleri</legend>
              ...
              <button
                ...
                className={cn(
                  ...
                  isSelected
                    ...
                    : 'border-slate-300 dark:border-ink-700 bg-white dark:bg-ink-900 text-slate-600 dark:text-ink-300 hover:border-primary-400',
                )}
              >
                {sport.name}
              </button>
      ...
      {/* Olanaklar */}
      <fieldset>
        <legend className="text-sm font-medium text-slate-700 dark:text-ink-200">Olanaklar</legend>
        <div className="mt-2 flex flex-wrap gap-2">
